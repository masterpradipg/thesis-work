...
from thesis_qubo.common import checkers
...
class BipartiteGraphAnnealer :
    ...
    def seed(self, seed) :
        ...
        Args:
          seed (int or long) :
            seed value
        """
        #  annealer use global random number genertor.
        pass
    ...
    def set_qubo(self, b0, b1, W, optimize = thesis_qubo.minimize) :
    ...
    def get_x(self) :
        x_pairs = []
        for idx in range(self._m) :
            x0 = thesis_qubo.bit_from_spin(self._q0[idx])
            x1 = thesis_qubo.bit_from_spin(self._q1[idx])
    ...
    def randomize_spin(self) :
        thesis_qubo.randomize_spin(self._q0)
        thesis_qubo.randomize_spin(self._q1)
...
def bipartite_graph_annealer(b0 = None, b1 = None, W = None, \
                             optimize = thesis_qubo.minimize, **prefs) :
...
if __name__ == '__main__' :
    ...
    an = bipartite_graph_annealer(b0, b1, W, thesis_qubo.minimize, n_trotters=m, algorithm=algo.coloring)
